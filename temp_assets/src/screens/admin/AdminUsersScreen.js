...
export const AdminUsersScreen = ({ route, navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* PMS Sync Modal */}
      <Modal visible={pmsModalVisible} animationType="fade" transparent>
         <View style={styles.modalOverlay}>
            <View style={[styles.modalContent, { borderBottomLeftRadius: 36, borderBottomRightRadius: 36, marginBottom: 100 }]}>
...
const styles = StyleSheet.create({
  ...
  pmsHint: { fontSize: 13, color: COLORS.gray[300], marginBottom: 25, fontWeight: '600', lineHeight: 20 },
